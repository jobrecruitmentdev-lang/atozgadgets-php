...
<div style="max-width: 1280px; margin: 0 auto; padding: 2.5rem 1.5rem;">
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb">
        ...
        <i data-lucide="chevron-right" style="width:13px;height:13px;"></i>
        <span class="breadcrumb-current">Tech Gifts</span>
    </nav>
    ...
    <div style="background: linear-gradient(135deg, rgba(201, 169, 98, 0.15) 0%, rgba(20, 20, 28, 0.9) 100%); border: 1px solid rgba(201, 169, 98, 0.35); border-radius: var(--radius-lg); padding: clamp(1.75rem, 4vw, 3rem) clamp(1rem, 3vw, 2rem); margin-bottom: 2.5rem; text-align: center;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 140px), 1fr)); gap: 0.85rem; max-width: 960px; margin: 0 auto;">
            <a href="{{ route('seo.gift_category', 'for-gamers') }}" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-md); padding: 1rem; text-decoration: none; color: inherit; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--brand-primary)'; this.style.transform='translateY(-3px)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'">
                <div style="font-size: 1.35rem; margin-bottom: 0.35rem;">🎮</div>
                <div style="font-weight: 700; color: var(--text-primary); margin-bottom: 0.25rem; font-size: 0.95rem;">For Gamers</div>
                <div style="font-size: 0.75rem; color: var(--text-secondary);">RGB gear, audio & desk upgrades</div>
            </a>
            <a href="{{ route('seo.gift_category', 'for-tech-lovers') }}" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-md); padding: 1rem; text-decoration: none; color: inherit; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--brand-primary)'; this.style.transform='translateY(-3px)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'">
                <div style="font-size: 1.35rem; margin-bottom: 0.35rem;">⚡</div>
                <div style="font-weight: 700; color: var(--text-primary); margin-bottom: 0.25rem; font-size: 0.95rem;">For Tech Lovers</div>
                <div style="font-size: 0.75rem; color: var(--text-secondary);">Innovative viral gadgets & tools</div>
            </a>
            <a href="{{ route('seo.gift_category', 'under-50') }}" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-md); padding: 1rem; text-decoration: none; color: inherit; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--brand-primary)'; this.style.transform='translateY(-3px)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'">
                <div style="font-size: 1.35rem; margin-bottom: 0.35rem;">🎁</div>
                <div style="font-weight: 700; color: var(--text-primary); margin-bottom: 0.25rem; font-size: 0.95rem;">Gifts Under $50</div>
                <div style="font-size: 0.75rem; color: var(--text-secondary);">High value, budget-friendly tech</div>
            </a>
            <a href="{{ route('seo.gift_category', 'under-100') }}" style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius-md); padding: 1rem; text-decoration: none; color: inherit; transition: all 0.2s;" onmouseover="this.style.borderColor='var(--brand-primary)'; this.style.transform='translateY(-3px)'" onmouseout="this.style.borderColor='rgba(255,255,255,0.1)'; this.style.transform='translateY(0)'">
                <div style="font-size: 1.35rem; margin-bottom: 0.35rem;">✨</div>
                <div style="font-weight: 700; color: var(--text-primary); margin-bottom: 0.25rem; font-size: 0.95rem;">Gifts Under $100</div>
                <div style="font-size: 0.75rem; color: var(--text-secondary);">Premium devices & smart hubs</div>
            </a>
        </div>
    </div>
    ...
    <div style="margin-bottom: 3.5rem;">
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 1.25rem; flex-wrap: wrap; gap: 8px;">
            <h2 style="font-size: 1.35rem; font-weight: 700; color: var(--text-primary);">Top Trending Gift Ideas</h2>
